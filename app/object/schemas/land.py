...
class LandBase(BaseModel):
    ...
    live_square_area: int = Field(..., description="The live square area of the land", examples=[100])
...
class LandUpdate(LandBase):
    ...
    live_square_area: Optional[int] = Field(None, description="The live square area of the land", examples=[100])
